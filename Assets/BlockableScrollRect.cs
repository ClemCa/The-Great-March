...
{
    [AddComponentMenu("UI/Blockable Scroll Rect", 37)]
    [SelectionBase]
    [ExecuteAlways]
    ...
    /// </summary>
    /// <remarks>
    /// BlockableScrollRect will not do any clipping on its own. Combined with a Mask component, it can be turned into a scroll view.
    /// </remarks>
    public class BlockableScrollRect : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
        /// <summary>
        ...
        /// {
        ///     public BlockableScrollRect myBlockableScrollRect;
        ...
        ///         if (option == 0)
        ///         {
        ///             myBlockableScrollRect.movementType = BlockableScrollRect.MovementType.Clamped;
        ///         }
        ///         else if (option == 1)
        ///         {
        ///             myBlockableScrollRect.movementType = BlockableScrollRect.MovementType.Elastic;
        ///         }
        ///         else if (option == 2)
        ///         {
        ///             myBlockableScrollRect.movementType = BlockableScrollRect.MovementType.Unrestricted;
        ///         }
        ///     }
        /// }
        /// ]]>
        ...
        [Serializable]
        /// <summary>
        /// Event type used by the BlockableScrollRect.
        /// </summary>
        public class BlockableScrollRectEvent : UnityEvent<Vector2> { }

        [SerializeField]
        private bool m_Blocked;
        /// <summary>
        /// Block the scroll rect from taking any input or moving.
        /// </summary>
        /// <example>
        /// <code>
        /// <![CDATA[
        ...
        ///     public void Start()
        ///     {
        ///         // block the scroll rect.
        ///         myBlockableScrollRect.blocked = true;
        ///     }
        /// }
        /// ]]>
        ///</code>
        ...
        /// <summary>
        /// The content that can be scrolled. It should be a child of the GameObject with BlockableScrollRect on it.
        /// </summary>
        /// <example>
        /// <code>
        /// <![CDATA[
        ...
        ///     public void Start()
        ///     {
        ///         // assigns the contect that can be scrolled using the BlockableScrollRect.
        ///         myBlockableScrollRect.content = scrollableContent;
        ///     }
        /// }
        /// ]]>
        ///</code>
        ...
        ///         if (myBlockableScrollRect.horizontal == true)
        ///         {
        ...
        ///         if (myBlockableScrollRect.vertical == true)
        ///         {
        ...
        ///         myBlockableScrollRect.elasticity = 3.0f;
        ///     }
        /// }
        /// ]]>
        ///</code>
        ...
        /// </summary>
        /// <remarks>
        /// Inertia means that the BlockableScrollRect content will keep scrolling for a while after being dragged. It gradually slows down according to the decelerationRate.
        /// </remarks>
        ...
        ///         myBlockableScrollRect.decelerationRate = 5.0f;
        ///     }
        /// }
        /// ]]>
        ///</code>
        ...
        /// <summary>
        /// Optional Scrollbar object linked to the horizontal scrolling of the BlockableScrollRect.
        /// </summary>
        /// <example>
        /// <code>
        /// <![CDATA[
        ...
        ///     public void Start()
        ///     {
        ///         // Assigns a scroll bar element to the BlockableScrollRect, allowing you to scroll in the horizontal axis.
        ///         myBlockableScrollRect.horizontalScrollbar = newScrollBar;
        ///     }
        /// }
        /// ]]>
        ///</code>
        ...
        /// <summary>
        /// Optional Scrollbar object linked to the vertical scrolling of the BlockableScrollRect.
        /// </summary>
        /// <example>
        /// <code>
        /// <![CDATA[
        ...
        ///     public void Start()
        ///     {
        ///         // Assigns a scroll bar element to the BlockableScrollRect, allowing you to scroll in the vertical axis.
        ///         myBlockableScrollRect.verticalScrollbar = newScrollBar;
        ///     }
        /// }
        /// ]]>
        ///</code>
        ...
        [SerializeField]
        private BlockableScrollRectEvent m_OnValueChanged = new BlockableScrollRectEvent();

        /// <summary>
        /// Callback executed when the position of the child changes.
        /// </summary>
        /// <remarks>
        /// onValueChanged is used to watch for changes in the BlockableScrollRect object.
        ...
        /// The UnityEvent.AddListener API for UI.BlockableScrollRect._onValueChanged takes a Vector2.
        ///
        ...
        /// shows how this can be done.The script is attached to the BlockableScrollRect object.
        /// </remarks>
        /// <example>
        /// <code>
        /// <![CDATA[
        ...
        /// {
        ///     static BlockableScrollRect BlockableScrollRect;
        ///
        ///     void Start()
        ///     {
        ///         BlockableScrollRect = GetComponent<BlockableScrollRect>();
        ///         BlockableScrollRect.onValueChanged.AddListener(ListenerMethod);
        ///     }
        ///
        ...
        ///</code>
        /// </example>
        public BlockableScrollRectEvent onValueChanged { get { return m_OnValueChanged; } set { m_OnValueChanged = value; } }
...
#pragma warning restore 649
        ...
        ///     public void Start()
        ///     {
        ///         //Checks if the BlockableScrollRect called "myBlockableScrollRect" is active.
        ///         if (myBlockableScrollRect.IsActive())
        ///         {
        ...
        {
            return base.IsActive() && m_Content != null && !blocked;
        }
        ...
        protected virtual void LateUpdate()
        {
            ...
            if (m_ViewBounds != m_PrevViewBounds || m_ContentBounds != m_PrevContentBounds || m_Content.anchoredPosition != m_PrevPosition)
            {
                ...
                UISystemProfilerApi.AddMarker("BlockableScrollRect.value", this);
        ...
        /// <summary>
        /// Helper function to update the previous data fields on a BlockableScrollRect. Call this before you change data in the BlockableScrollRect.
        /// </summary>
        ...
        ///         myBlockableScrollRect.normalizedPosition = myPosition;
        ///     }
        /// }
        /// ]]>
        ///</code>
        ...
        ///         myBlockableScrollRect.horizontalNormalizedPosition = 0.5f;
        ///     }
        /// }
        /// ]]>
        ///</code>
        ...
        ///         myBlockableScrollRect.verticalNormalizedPosition = 0.5f;
        ///     }
        /// }
        /// ]]>
        ///</code>
        ...
        /// <summary>
        /// Calculate the bounds the BlockableScrollRect should be using.
        /// </summary>
